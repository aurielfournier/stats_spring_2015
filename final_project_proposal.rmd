...
models[[1]] <- lm(dist~jdate, data=dist)
models[[2]] <- lm(dist~region, data=dist)
models[[3]] <- lm(dist~canwr, data=dist)
models[[4]] <- lm(dist~round, data=dist)
models[[5]] <- lm(dist~species, data=dist)
