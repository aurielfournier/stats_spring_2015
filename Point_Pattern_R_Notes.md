...
## 
## data:  pp.cluster
## X2 = 43.1429, df = 15, p-value = 0.0002992
## alternative hypothesis: two.sided
## 
## Quadrats: 4 by 4 grid of tiles
```
...
## 
## data:  pp.regular
## X2 = 3.36, df = 15, p-value = 0.001611
## alternative hypothesis: two.sided
## 
## Quadrats: 4 by 4 grid of tiles
```
...
## (Intercept)           x           y 
##   0.0734499   0.5023653   0.2510647 
## 
##              Estimate        S.E.    CI95.lo   CI95.hi Ztest       Zval
## (Intercept) 0.0734499 0.044157650 -0.0130975 0.1599973         1.663356
## x           0.5023653 0.004563071  0.4934219 0.5113088   *** 110.093702
## y           0.2510647 0.003315179  0.2445671 0.2575624   ***  75.731883
```
...
## Intensity: 145.73
##             Estimate        S.E. CI95.lo  CI95.hi Ztest    Zval
## log(lambda) 4.981756 0.008283722 4.96552 4.997991   *** 601.391
```
...
```
## [1] 0.42851898 0.09462536 0.44755939 0.25001317 0.32455914
```
